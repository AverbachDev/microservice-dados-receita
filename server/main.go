...
func Start() {
	...
	c.AddFunc("CRON_TZ=America/Sao_Paulo 00 18 * * *", func() { service.Download() }) //download arquivos receita todo dia 1 as 00:30
	c.AddFunc("CRON_TZ=America/Sao_Paulo 30 20 * * *", func() { stepsImport() })      //processamento da base todo dia 1 as 19:30
	c.Start()
